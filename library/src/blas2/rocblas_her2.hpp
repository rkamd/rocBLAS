...
__global__ __launch_bounds__(DIM_X* DIM_Y) void rocblas_her2_kernel(bool           upper,
                                                                    rocblas_int    n,
                                                                    TScal          alphaa,
                                                                    TConstPtr      xa,
                                                                    ptrdiff_t      shift_x,
...
ROCBLAS_EXPORT_NOINLINE rocblas_status rocblas_her2_template(rocblas_handle handle,
                                                             rocblas_fill   uplo,
                                                             rocblas_int    n,
                                                             TScal          alpha,
                                                             TConstPtr      x,
